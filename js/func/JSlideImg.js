            ...
            if(!$.isEmptyObject(thumb)){
                if(thumb['state']) {
                    ...
                    if (thumb['type'] == 'vertical') {
                        ...
                        var thumbH = (((thumb['height']+12) * thumbAmt) + (btnH*2));
                        ...
                        if (thumb['position'] === 'auto'){
                            ...
                            if (thumb['overlapPos'] == 'right') {
                                var thumbPos = 'right:10px;top:'+posH+'px;';
                            }else{
                                var thumbPos = 'left:10px;bottom:'+posH+'px;';
                            }
                        }else{
                        ...
                        var thumbW = (((thumb['width']+12) * thumbAmt) + (btnW*2));
                        ...
                        if (thumb['position'] === 'auto'){
                            ...
                            if (thumb['overlapPos'] == 'top') {
                                var thumbPos = 'left:'+posW+'px;top:10px;';
                            }else{
